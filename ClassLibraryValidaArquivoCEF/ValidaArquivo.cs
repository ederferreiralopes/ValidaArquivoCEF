...
namespace ClassLibraryValidaArquivoCEF
{
    ...
    {
        public void lerRemessaCnab240(string caminho, string caminhoLogValidacao)
        {
            ...
            StreamWriter sw = new StreamWriter(caminhoLogValidacao + "\\validacao.log", true);
            ...
            try
            {
                ...
                while (((linha = sr.ReadLine()) != null))
                {
                    ...
                    if (linha.Length > 7)
                    {
                        ...
                        {
                            mensagemValidacao +=("Erro no campo: Código do Banco = " + codBanco + " : código pradão é 104\n");
                        }
                        ...
                        switch (codRegistro)
                        {
                            case "0":
                                ...
                                mensagemValidacao += ("Validando arquivo: " + Path.GetFileName(caminho) + "\n\n");
                                //mensagemValidacao += ("Linha: " + contadorLinhas + ": Validando registro do Tipo: 0 (Header Remessa)...\n");
                                ...
                                mensagemValidacao += ("Nome da Empresa: " + linhaHeaderRemessa.Substring(72, 30) + "\n");
                                if (linha.Substring(17, 1).Contains("1"))
                                {
                                    mensagemValidacao += ("CPF: " + linhaHeaderRemessa.Substring(18, 14) + "\n");
                                }
                                if (linha.Substring(17, 1).Contains("2"))
                                {
                                    mensagemValidacao += ("CNPJ: " + linhaHeaderRemessa.Substring(18, 14) + "\n");
                                }
                                mensagemValidacao += ("Convênio: " + linhaHeaderRemessa.Substring(32, 6) + "\nNSA: " + linhaHeaderRemessa.Substring(157, 6) + "\n\n");
                                break;

                            case "1":
                                linhaHeaderLote = linha;
                                //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: 1 (Header Lote)...\n");
                            ...
                            case "3":
                                ...
                                {
                                    //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: A...\n");
                                ...
                                {
                                    //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: B...\n");
                                ...
                                {
                                    //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: J...\n");
                                ...
                                {
                                    //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: K...\n");
                            ...
                            case "5":
                                ...
                                //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: 5 (Trailler Lote)...\n");
                                try
                                {
                                    ...
                                    {
                                        mensagemValidacao +=("Erro no campo: Somatório de registros do lote: " + campoQuantRegLote + " A soma dos registros neste lote é: " + quantRegLote + "\n");
                                    }
                                    ...
                                    if (campoSomaValorPagamento != somaValorPagamento)
                                    {
                                        ...
                                        mensagemValidacao += ("Erro no campo: Somatório de valores: " + campoSomaValorPag + " A soma dos valores neste lote é: " + somaValorPag + "\n");
                                    }

                                    if (campoSomaQuantMoeda != somaQuantMoeda)
                                    {
                                        mensagemValidacao += ("Erro no campo: Somatório de quantidade moeda: " + campoSomaQuantMoeda + " A soma de quantidade moeda neste lote é: " + somaQuantMoeda + "\n");
                                    }
                                }
                                catch (Exception erro)
                                {
                                    mensagemValidacao += ("Erro na formatação do registro do Tipo: 5 (Trailler Lote)...\n" + erro + "\n");
                                }
                            ...
                            case "9":
                                ...
                                //mensagemValidacao +=("Linha: " + contadorLinhas + ": Validando registro do Tipo: 9 (Trailler Remessa)...\n");
                            ...
                            default:
                                mensagemValidacao += ("Linha: " + contadorLinhas + ": Não foi possível identificar a linha: " + linha + "\n");
                                break;
                        }
                    }
                    else { mensagemValidacao += ("Linha: " + contadorLinhas + ": Não foi possível identificar a linha: " + linha + "\n"); }
                } // fecha o laço while
            ...
            {
                mensagemValidacao += ("Ocorreu um erro ao ler o arquivo: " + ex + "\n");
            }
            ...
            {
                mensagemValidacao += ("\nQuantidade de lotes: " + contadorHeaderLote + "\nQuantidade de pagamentos: " + quantPagamento + "\nQuantidade de linhas lidas: " + contadorLinhas + "\n\n");
            }
            else
            {
                mensagemValidacao +=("\nProblema com HEADER ou TRAILLER da remessa!\nQuant. Header: " + contadorHeaderRemessa + "\nQuant. Trailler: " + contadorTraillerRemessa + "\n\n");
            }
            sw.Write(mensagemValidacao);
            sw.Close();
        }

        public void lerRetornoCnab240(string caminho, string caminhoLogValidacao)
        {
                    ...
                    if (linha.Length > 7)
                    {
                        ...
                        switch (codRegistro)
                        {
                            case "0":
                                ...
                                mensagemValidacao += ("Analisando retorno: " + Path.GetFileName(caminho) + "\n\n");
                                //mensagemValidacao += ("Linha: " + contadorLinhas + ": Validando registro do Tipo: 0 (Header Retorno)...\n");
                                contadorHeaderRetorno++;

                                mensagemValidacao += ("Nome da Empresa: " + linhaHeaderRetorno.Substring(72, 30) + "\n");
                                if (linha.Substring(17, 1).Contains("1"))
                                {
                                    mensagemValidacao += ("CPF: " + linhaHeaderRetorno.Substring(18, 14) + "\n");
                                }
                                if (linha.Substring(17, 1).Contains("2"))
                                {
                                    mensagemValidacao += ("CNPJ: " + linhaHeaderRetorno.Substring(18, 14) + "\n");
                                }
                                mensagemValidacao += ("Convênio: " + linhaHeaderRetorno.Substring(32, 6) + "\nNSA: " + linhaHeaderRetorno.Substring(157, 6) + "\n\n");
                                break;
                            ...
                            case "3":
                                ...
                                if (linha.Substring(13, 1).Equals("A", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    mensagemValidacao += ("Linha: " + contadorLinhas + ": Pagamento do tipo: A...\n");
                                    ...
                                    mensagemValidacao += (" - Banco: " + codBancoDestino + " - Ag: " + codAgenciaDestino + "-" + dvAgenciaDestino + " - Cta: " + contaCorrenteDestino + "-" + dvAgenciaDestino + "-" + dvAgenciaContaDestino + "\n - Favorecido: " + nomeFavorecido + "\n - Numero do Documento: " + numDocAtribuidoEmpresa + " - Vencimento: " + dataVencimento + " - Valor: " + valorLancamento + "\n - Ocorrências: " + ocorrencias + "\n");
                                }

                                if (linha.Substring(13, 1).Equals("B", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    //mensagemValidacao +=("Linha: " + contadorLinhas + ": Pagamento do tipo: B...\n");
                                    //Auxiliar auxLoteSeg = new Auxiliar();
                                ...
                                if (linha.Substring(13, 1).Equals("J", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    mensagemValidacao += ("Linha: " + contadorLinhas + ": Pagamento do tipo: J...\n");
                                    ...
                                    ocorrencias = aux.TrataOcorencias(ocorrencias);
                                    mensagemValidacao += (" - Banco: " + bancoDestino + " - Cedente: " + nomeCedente + " - Numero do Documento: " + numDocumentoEmpresa + " - Vencimento: " + dataVencimento + " - Valor: " + valorPagamento + "\n - Ocorrências: " + ocorrencias + "\n");
                                }

                                if (linha.Substring(13, 1).Equals("K", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    mensagemValidacao += ("Linha: " + contadorLinhas + ": Pagamento do Tipo: K...\n");
                                    ...
                                    mensagemValidacao += (" - Segmento empresa: " + codSegmentoEmpresa + " - Numero do Documento: " + numDocEmpresa + "\n - Data: " + dataLancamento + " - Valor: " + valorLancamento + "\n - Ocorrências: " + ocorrencias + "\n");
                            ...
                            case "5":
                                ...
                                try
                                {
                                    ...
                                    if (campoQuantRegLote != quantRegLote)
                                    {
                                        mensagemValidacao += ("Linha: " + contadorLinhas + " Erro no campo: Somatório de registros do lote: " + campoQuantRegLote + " A soma dos registros neste lote é: " + quantRegLote + "\n");
                                    }
                                    ...
                                    if (campoSomaValorPagamento != somaValorPagamento)
                                    {
                                        ...
                                        string campoSomaValorPag = aux.converteEmMoeda(contadorLinhas, linha, campoSomaValorPagamento.ToString());
                                        string somaValorPag = aux.converteEmMoeda(contadorLinhas, linha, somaValorPagamento.ToString());
                                        mensagemValidacao += ("Linha: " + contadorLinhas + " Erro no campo: Somatório de valores: " + campoSomaValorPag + " A soma dos valores neste lote é: " + somaValorPag + "\n");
                                    }

                                    if (campoSomaQuantMoeda != somaQuantMoeda)
                                    {
                                        mensagemValidacao += ("Linha: " + contadorLinhas + " Erro no campo: Somatório de quantidade moeda: " + campoSomaQuantMoeda + " A soma de quantidade moeda neste lote é: " + somaQuantMoeda + "\n");
                                    }
                                }
                                catch (Exception erro)
                                {
                                    mensagemValidacao += ("Linha: " + contadorLinhas + " Erro na formatação do registro do Tipo: 5 (Trailler Lote)...\n" + erro + "\n");
                                }
                                quantRegLote = 2;
                                somaQuantMoeda = 0;
                                somaValorPagamento = 0;
                            ...
                            case "9":
                                ...
                                //mensagemValidacao += ("Linha: " + contadorLinhas + ": Validando registro do Tipo: 9 (Trailler Retorno)...\n");
                                try
                                {
                                    int quantRegistrosArq = int.Parse(linhaTraillerRetorno.Substring(23, 6));
                                    if (contadorLinhas != quantRegistrosArq)
                                    {
                                        mensagemValidacao += ("Linha: " + contadorLinhas + " Erro no campo: Quantidade de Registros do Arquivo: " + quantRegistrosArq + " A soma de linhas neste arquivo é: " + contadorLinhas + "\n");
                                    }
                                }
                                catch (Exception erro)
                                {
                                    mensagemValidacao += ("Linha: " + contadorLinhas + " Erro na formatação do registro do Tipo: 9 (Trailler Retorno)...\n" + erro + "\n");
                                }
            ...
            {
                mensagemValidacao += ("Linha: " + contadorLinhas + " Ocorreu um erro ao ler o arquivo: " + ex + "\n");
            }
            catch (FormatException ex)
            {
                mensagemValidacao += ("Linha: " + contadorLinhas + " Ocorreu um erro ao ler o arquivo: " + ex + "\n");
            ...
            {
                mensagemValidacao += ("\nProblema com HEADER ou TRAILLER da Retorno!\nQuant. Header: " + contadorHeaderRetorno + "\nQuant. Trailler: " + contadorTraillerRetorno + "\n\n");
            }
            sw.Write(mensagemValidacao);
            sw.Close();
        }
