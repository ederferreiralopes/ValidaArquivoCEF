            ...
            else
            {
                try
                {
                    ...
                    try {
                            ...
                            {
                                validacao += ("Linha: " + numLinha + " Erro no campo: Quantidade de Lotes no Arquivo = " + quantLotesArq + " : deveria ser: " + quantLote + "\n");
                            }
                        }
                    ...
                    try {
                            ...
                            {
                                validacao += ("Linha: " + numLinha + " Erro no campo: Quantidade de Registros do Arquivo = " + quantRegistrosArq + " : deveria ser: " + numLinha + "\n");
                            }
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Uso FEBRABAN = " + usoFebraban2 + " : preencher com espaços!\n");
                    }

                }
                catch (Exception erro)
                {
                    validacao +=("Linha: " + numLinha + " não consegui ler a linha do registro 5 = " + linha + "\n" + erro);
                }
            }
