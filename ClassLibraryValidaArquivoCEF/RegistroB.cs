        ...
        internal void validaRegistroB(string linha, int numLinha)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Num. Inscricao = " + numInscricao + " : preencher com CPF ou CNPJ\n");
                    }
                    ...
                    try
                    {
                        if (numLocal.Trim().Length < numLocal.Length)
                        {
                            ...
                            {
                                textoValidacao += ("Linha: " + numLinha + " Erro no campo: Número no local = " + numLocal + " : favor preencher - Exemplo: 00007 \n");
                            }
                    ...
                    if (bairro.Contains("               "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Bairro = " + logradouro + " : está em branco!\n");
                    }
                    ...
                    if (cep.Trim().Length < cep.Length)
                    {
                        ...
                        else textoValidacao += ("Linha: " + numLinha + " Erro no campo: CEP = " + cep + " : preencher com o zero a esquerda\n");
                    }
                    ...
                    if (complementoCep.Trim().Length < complementoCep.Length)
                    {
                        ...
                        {
                            textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: CEP = " + complementoCep + " : preencher com o zero a esquerda\n");
                        }
                        else textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: CEP = " + complementoCep + " : preencher com o zero a esquerda\n");
                    }
                    ...
                    { 
                        ...
                        {
                            textoValidacao +=  ("Linha: " + numLinha + " Atenção no campo: Data de Vencimento = " + dataVencimento + " : já está vencida!\n");
                        }
                    }
                    catch (Exception erro) { textoValidacao += ("Linha: " + numLinha + " Erro no campo: Data de Vencimento = " + dataVencimento + " : preencher com a data de vencimento\n"); }
                    //faz o resto logo!!

                    if (!valorDocumento.Contains("000000000000000"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Valor do Documento = " + valorDocumento + " : preencher com zeros!\n");
                    }

                    if (!valorAbatimento.Contains("000000000000000"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Valor do Abatimento = " + valorAbatimento + " : preencher com zeros!\n");
                    }

                    if (!valorDesconto.Contains("000000000000000"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Valor do Desconto = " + valorDesconto + " : preencher com zeros!\n");
                    }

                    if (!valorMora.Contains("000000000000000"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Valor da Mora = " + valorMora + " : preencher com zeros!\n");
                    }

                    if (!valorMulta.Contains("000000000000000"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Valor da Multa = " + valorMulta + " : preencher com zeros!\n");
                    }
