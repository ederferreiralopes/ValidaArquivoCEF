            ...
            else
            {
                try
                {
                    ...
                    switch (tipoMovimento)
                    {
                        case "0": break;
                        case "9": break;
                        default: textoValidacao += ( "Linha: " + numLinha + " Erro no campo: tipo de Movimento = " + tipoMovimento + " : preencher com “0” (inclusão) ou “9” (exclusão)\n");
                            break;
                    }
                    ...
                    switch (codMovimento)
                    {
                        ...
                        case "23": break;
                        case "99": break;
                        default: textoValidacao += ( "Linha: " + numLinha + " Erro no campo: cod. de Movimento = " + codMovimento + " : preencher conforme tabela G061\n");
                            break;
                    }
                    ...
                    try
                    {
                        ...
                        switch (codMoeda)
                        {
                            case "0": break;
                            case "9": break;
                            default: textoValidacao += ( "Linha: " + numLinha + " Atenção no campo: Cod. moeda = " + codMoeda + " : Está diferente do padrão FEBRABAN\n");
                                break;
                        }
                    }
                    ...
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Erro no campo: Campo Livre = " + campoLivre + " : está em branco! preencher conforme constante da 20a a 44a posições na barra da cobrança\n");
                    }

                    if (nomeCedente.Contains("                              "))
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Erro no campo: Nome do Cedente = " + nomeCedente + " : está em branco! preencher com Nome do Cedente\n");
                    }
                    ...
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Erro no campo: Número documento atribuído pela empresa = " + numDocumentoEmpresa + " : está em branco!\n");
                    }

                    if (!filler23.Contains("              "))
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Erro no campo: Filler = " + filler23 + " : preencher com espaços!\n");
                    }

                    if (!numDocumentoBanco.Contains("         "))
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Atenção no campo: Número documento atribuído pelo banco = " + numDocumentoBanco + " : preencher com espaços!\n");
                    }
                    ...
                    try
                    {
                        ...
                        switch (codigoDaMoeda)
                        {
                            ...
                            case "06": break;
                            case "09": break;
                            default: textoValidacao += ( "Linha: " + numLinha + " Atenção no campo: Código da Moeda = " + codigoDaMoeda + " : Está diferente do padrão FEBRABAN\n");
                                break;
                        }
                    }
                    ...
                    {
                        textoValidacao += ( "Linha: " + numLinha + " Erro no campo: Ocorrências do Retorno = " + ocorrenciasRetorno + " : preencher com espaços!\n");
                    }
