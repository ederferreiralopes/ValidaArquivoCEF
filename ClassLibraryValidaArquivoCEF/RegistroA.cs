...
namespace ClassLibraryValidaArquivoCEF
{
    class RegistroA
    {
        ...
        internal void validaRegistroA(string linha, int numLinha)
        {
            if (linha.Length != 240)
            {
                textoValidacao +=("Linha: " + numLinha + " Fora do Padrão: quantidade de colunas é difente de 240! esta linha possui: " + linha.Length + " colunas\n");
            }
            else
            {
                try
                {
                    ...
                    switch (tipoMovimento)
                    {
                        case "0": break;
                        case "9": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Atenção no campo: Tipo de movimento = " + tipoMovimento + " : preencher: “0” - inclusão ou “9” - exclusão\n");
                            break;
                    }

                    if (!codInstrucaoMovimento.Contains("00"))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Código Instrução Movimento = " + codInstrucaoMovimento + " : preencher com “00”\n");
                    }
                    ...
                    switch (camaraCompensacao)
                    {
                        case "018": break;
                        case "700": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Câmara de Compensação = " + camaraCompensacao + " : preencher: “018” – Finalidade TED ou “700” – Finalidade DOC\n");
                            break;
                    }
                    ...
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Código da Agência de Destino = " + codAgenciaDestino + " : preencher com código da Agência do favorecido\n");
                    }

                    if (dvAgenciaDestino.Contains(" "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  DV Agência de Destino = " + dvAgenciaDestino + " : preencher com o dígito verificador da Agência do favorecido\n");
                    }
                    ...
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Conta Corrente Destino = " + contaCorrenteDestino + " : preencher com o número da conta corrente do favorecido\n");
                    }

                    if (dvContaDestino.Contains(" ") && codBancoDestino.Equals("104"))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  DV Conta Destino = " + dvContaDestino + " : preencher com o dígito verificador da conta corrente do favorecido\n");
                    }

                    if (!dvAgenciaContaDestino.Contains(" "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  DV Agência/Conta Destino = " + dvAgenciaContaDestino + " : preencher com espaço\n");
                    }

                    if (nomeFavorecido.Contains("                              "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Nome do terceiro = " + nomeFavorecido + " : preencher com o nome do favorecido\n");
                    }
                    ...
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Número do Documento Atribuído pela Empresa = " + numDocAtribuidoEmpresa + " : preencher com o número do agendamento atribuído pela empresa\n");
                    }

                    if (!filler.Contains("             "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Filler = " + filler + " : preencher com espaços\n");
                    }
                    ...
                    switch (tipoConta)
                    {
                        ...
                        case "1": break;
                        case "2": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Tipo de conta – Finalidade TED = " + tipoConta + " : preencher: “0” – Sem conta ou “1” – Conta corrente ou “2” – Poupança\n");
                            break;
                    }
                    ...
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Data de vencimento = " + dataVencimento + " : preencher com a data de vencimento do agendamento (DDMMAAAA)\n");
                    }
                    ...
                    switch (tipoMoeda)
                    {
                        ...
                        case "UFR": break;
                        case "TRD": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Tipo de Moeda = " + tipoConta + " : preencher: “BRL”(Real) ou “USD”(Dólar Americano) ou “UFR”(UFIR) ou “TRD”(Taxa Referencial Diária)\n");
                            break;
                    }
                    ...
                    try
                    {
                        ...
                        {
                            textoValidacao +=("Linha: " + numLinha + " Erro no campo: Quantidade de Moeda = " + quantMoeda + "informar a quantidade de moeda a ser convertida\n");
                        }
                    }
                    catch (Exception e)
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Quantidade de Moeda = " + quantMoeda + " : informar a quantidade de moeda a ser convertida, quando moeda BRL preencher com zeros\n");
                    }
                    ...
                    try
                    {
                        ...
                        {
                            textoValidacao +=("Linha: " + numLinha + " Erro no campo: Valor do Lançamento = " + valorLancamento + "informar o valor do lançamento quando tipo de moeda BRL\n");
                        }
                    }
                    catch (Exception e)
                    {
                    ...
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Número Documento Banco = " + numDocBanco + " : preencher com zeros\n");
                    }

                    if (!filler24.Contains("   "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Filler = " + filler24 + " : preencher com espaços\n");
                    }
                    ...
                    try
                    {
                        ...
                        if (numParcelas < 1)
                        {
                            textoValidacao +=("Linha: " + numLinha + " Erro no campo: Quantidade de Parcelas = " + quantParcelas + " :preencher com a quantidade de parcelas a ser efetuado o pagamento, para pagamento único preencher com “01”\n");
                        }
                    }
                    catch (Exception e)
                    {
                    ...
                    switch (indicadorBloqueio)
                    {
                        case "S": break;
                        case "N": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Indicador de Bloqueio = " + indicadorBloqueio + " : preencher: S - Bloqueia as demais parcelas ou N - Não bloqueia as demais parcelas\n");
                            break;
                    }
                    ...
                    switch (indicadorFormaParcelamento)
                    {
                        ...
                        case "2": break;
                        case "3": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Indicador Forma de Parcelamento = " + indicadorFormaParcelamento + " : preencher: “1” - Data Fixa ou “2” - Periódico ou “3” - Dia útil\n");
                            break;
                    }

                    if (periodoOuDiaVencimento.Contains("  "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Período ou dia de vencimento = " + periodoOuDiaVencimento + " : preencher com número desejado para o tratamento do Indicador da Forma de Parcelamento\n");
                    }
                    try
                    {
                        if (!numeroParcela.Contains("00") && quantParcelas.Contains("1"))
                        {
                            textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Número Parcela = " + numeroParcela + " : Quando parcela única informar “00”\n");
                        }
                    ...
                    catch (Exception e) { textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Data da efetivação = " + dataEfetivacao + " : na remessa deve ser preenchido com zeros\n"); }

                    try { int.Parse(valorRealEfetivado); }
                    catch (Exception e) { textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Valor Real Efetivado = " + valorRealEfetivado + " : na remessa deve ser preenchido com zeros\n"); }

                    if (!informacao2.Contains("                                        "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo:  Informação 2 = " + informacao2 + " : preencher com espaços\n");
                    }
                    ...
                    switch (FinalidadeDoc)
                    {
                        ...
                        case "11": break;
                        case "00": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Finalidade DOC = " + FinalidadeDoc + " : preencher conforme tabela P005, se não for DOC preencher com “00”\n");
                            break;
                    }

                    if (!usoFebraban.Contains("          "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Uso FEBRABAN = " + usoFebraban + " : preencher com espaços!\n");
                    }
                    ...
                    switch (avisoFavorecido)
                    {
                        ...
                        case "6": break;
                        case "7": break;
                        default: textoValidacao +=("Linha: " + numLinha + " Erro no campo: Aviso ao Favorecido = " + avisoFavorecido + " : preencher conforme tabela P006\n");
                            break;
                    }

                    if (!ocorrencias.Contains("          "))
                    {
                        textoValidacao +=("Linha: " + numLinha + " Erro no campo: Ocorrências do Retorno = " + ocorrencias + " : preencher com espaços!\n");
                    }

                }
                catch (Exception erro)
                {
                    textoValidacao +=("Linha: " + numLinha + " não consegui ler a linha do registro J = " + linha + "\n" + erro);
                }
            }
        }
    }
