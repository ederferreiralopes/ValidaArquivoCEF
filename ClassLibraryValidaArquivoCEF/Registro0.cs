...
namespace ClassLibraryValidaArquivoCEF
{
    class Registro0
    {
        ...
        public void valida(string linha, int numLinha, string validacao)
        {
            if (linha.Length != 240)
            {
                validacao +=("Linha: " + numLinha + " Fora do Padrão: quantidade de colunas é difente de 240! esta linha possui: " + linha.Length + " colunas\n");
            }
            else
            {
                try
                {
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Lote do Servico = " + loteServico + " : o pradão é 0000\n");
                    }

                    if (!filler4.Contains("         "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: filler 4 = " + filler4 + " : preencher com espaços\n");
                    }
                    ...
                    switch (tipoInscricao)
                    {
                        case "1": break;
                        case "2": break;
                        default: validacao +=("Linha: " + numLinha + " Erro no campo: Num. Inscricao = " + tipoInscricao + " : preencher com 1 (pessoa física) ou 2 (pessoa jurídica)\n");
                            break;
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Num. Inscricao = " + linha.Substring(18, 32) + " : preencher com CPF ou CNPJ\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Cod. Convênio = " + linha.Substring(32, 38) + " : preencher com o código do convênio informado pelo Banco\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Param. Trans. = " + linha.Substring(38, 40) + " : preencher com o código informado pelo Banco\n");
                    }
                    ...
                    switch (ambienteCliente)
                    {
                        case "T": break;
                        case "P": break;
                        default: validacao +=("Linha: " + numLinha + " Erro no campo: Ambiente Cliente = " + ambienteCliente + " : preencher com T(teste) ou P(produção)\n");
                            break;
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Ambiente Caixa = " + ambienteCaixa + " : preencher com espaços\n");
                    }

                    if (!origemAplicativo.Contains("   "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Origem Aplicativo = " + origemAplicativo + " : preencher com espaços\n");
                    }

                    if (!numVersao.Contains("0000"))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Num. Versao = " + numVersao + " : preencher com zeros\n");
                    }

                    if (!filler13.Contains("   "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: filler 13 = " + filler13 + " : preencher com espaços\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Ag. Conta Corrente = " + linha.Substring(52, 57) + " : preencher com o num. da Agência da Conta Corrente\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: DV. da Agencia = " + linha.Substring(57, 58) + " : preencher com o DV. da Agencia\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Num. da Conta = " + linha.Substring(58, 70) + " : preencher com o num. da Conta\n");
                    }

                    if (dvConta.Contains(" "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: DV. da Conta = " + dvConta + " : está em branco!\n");
                    }

                    if (!dvAgenciaConta.Contains(" "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: DV. Agencia da Conta = " + dvAgenciaConta + " : preencher com espaços\n");
                    }

                    if (nomeEmpresa.Contains("                              "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Nome da Empresa = " + nomeEmpresa + " : está em branco!\n");
                    }

                    if (nomeBanco.Equals("CAIXA", StringComparison.InvariantCultureIgnoreCase))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: Nome do Banco = " + nomeBanco + " : o pradão é CAIXA\n");
                    }

                    if (!filler21.Contains("          "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: filler 21 = " + filler21 + " : preencher com espaços\n");
                    }

                    if (!codRemessaRetorno.Contains("1"))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: cod. Remessa = " + codRemessaRetorno + " : o pradão é 1\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: data de geração do arquivo = " + linha.Substring(143, 151) + " : preencher com a data de geração do arquivo\n");
                    }
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: hora de geração do arquivo = " + linha.Substring(151, 157) + " : preencher com a hora de geração do arquivo\n");
                    }
                    ...
                    try
                    {
                        ...
                        {
                            validacao +=("Linha: " + numLinha + " Erro no campo: Nsa = " + linha.Substring(157, 163) + " : Nsa deve ser maior que 0\n");
                        }
                        else
                        {
                            int.Parse(Nsa);
                    ...
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: hora de geração do arquivo = " + linha.Substring(157, 163) + " : preencher com a hora de geração do arquivo\n");
                    }

                    if (!verLayout.Contains("080"))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: ver. do Layout = " + verLayout + " : o pradão é 080\n");
                    }

                    if (!densidadeGravacao.Contains("01600"))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: densidade de gravacao = " + densidadeGravacao + " : o pradão é 01600\n");
                    }

                    if (!reservadoBanco.Contains("                    "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: reservado ao Banco = " + reservadoBanco + " : preencher com espaços\n");
                    }

                    if (!reservadoEmpresa.Contains("                    "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: reservado a Empresa = " + reservadoEmpresa + " : preencher com espaços\n");
                    }

                    if (!usoFebraban.Contains("           "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: reservado ao uso da Febraban = " + usoFebraban + " : preencher com espaços\n");
                    }

                    if (!idCobranca.Contains("   "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: id de cobranca = " + idCobranca + " : preencher com espaços\n");
                    }

                    if (!usoVan.Contains("000"))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: reservado ao uso da van = " + usoVan + " : o padrão é 000\n");
                    }

                    if (!tipoServico.Contains("  "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: tipo de servico = " + tipoServico + " : preencher com espaços\n");
                    }

                    if (!ocorenciaCob.Contains("          "))
                    {
                        validacao +=("Linha: " + numLinha + " Erro no campo: ocorencia de Cobrança = " + ocorenciaCob + " : preencher com espaços\n");
                    }
