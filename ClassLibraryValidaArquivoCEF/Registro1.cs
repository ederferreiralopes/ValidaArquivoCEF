            ...
            else
            {
                try
                {
                    ...
                    switch (tipoOperacao)
                    {
                        case "C": break;
                        case "D": break;
                        default: textoValidacao += ("Linha: " + numLinha + " Erro no campo: tipo de Operação = " + tipoOperacao + " : preencher com C (compromisso de pagamento) ou D (compromisso de recebimento)\n");
                            break;
                    }
                    ...
                    switch (tipoServico)
                    {
                        ...
                        case "90": break;
                        case "98": break;
                        default: textoValidacao += ("Linha: " + numLinha + " Erro no campo: tipo de Serviço = " + tipoServico + " : preencher conforme tabela G025\n");
                            break;
                    }
                    ...
                    switch (formaLancamento)
                    {
                        ...
                        case "41": break;
                        case "50": break;
                        default: textoValidacao += ("Linha: " + numLinha + " Erro no campo: tipo de Serviço = " + formaLancamento + " : preencher conforme tabela G029\n");
                            break;
                    }

                    if (!verLayoutLote.Contains("041"))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: ver. do layout do lote = " + verLayoutLote + " : o pradão é 041\n");
                    }

                    if (!filler8.Contains(" "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: filler 8 = " + filler8 + " : preencher com espaços\n");
                    }
                    ...
                    switch (tipoInscricao)
                    {
                        case "1": break;
                        case "2": break;
                        default: textoValidacao += ("Linha: " + numLinha + " Erro no campo: Num. Inscricao = " + tipoInscricao + " : preencher com 1 (pessoa física) ou 2 (pessoa jurídica)\n");
                            break;
                    }
                    ...
                    switch (tipoCompromisso)
                    {
                        ...
                        case "06": break;
                        case "11": break;
                        default: textoValidacao += ("Linha: " + numLinha + " Erro no campo: tipo de compromisso = " + tipoCompromisso + " : preencher com o tipo de compromisso:\n");
                            textoValidacao += ("Linha: " + numLinha + "  >>>>  01 (Pag. Fornecedor), 02 (Pag. Salários), 03 (Autopagamento), 06 (Salário Ampliação de Base), 11 (Débito em conta) \n");
                            break;
                    }
                    ...
                    {
                        textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: Cod. compromisso = " + codCompromisso + " : preencher com o código do compromisso informado pelo Banco\n");
                    }

                    if (paramTrans.Contains("  "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: param. de Transmissão = " + paramTrans + " : está em branco! preencher com o código informado pelo Banco\n");
                    }

                    if (!filler15.Contains("      "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: filler 15 = " + filler15 + " : preencher com espaços\n");
                    }
                    ...
                    {
                        textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: ag. conta corrente = " + agContaCorrente + " : preencher com a agência da conta\n");
                    }

                    if (dvAgencia.Contains(" "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: DV. da agência = " + dvAgencia + " : está em branco! preencher com DV. da agência\n");
                    }
                    ...
                    {
                        textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: num. da conta corrente = " + numContaCorrente + " : preencher com num. da conta corrente\n");
                    }

                    if (DvContaCorrente.Contains(" "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: DV da Conta Corrente = " + DvContaCorrente + " : está em branco! preencher com DV da Conta Corrente\n");
                    }

                    if (!digAgConta.Contains(" "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: dígito da Agência/Conta = " + digAgConta + " : preencher com espaços\n");
                    }

                    if (nomeEmpresa.Contains("                              "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Nome da Empresa = " + nomeEmpresa + " : está em branco!\n");
                    }
                    ...
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Logradouro = " + logradouro + " : está em branco!\n");
                    }
                    ...
                    try
                    {
                        ...
                        {
                            textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: Número no local = " + numLocal + " : preencher com o zero a esquerda\n");
                        }
                    }
                    catch (Exception e)
                    {
                        textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: Número no local = " + numLocal + " : preencher com o número no local\n");
                    }

                    if (complemento.Contains("               "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Atenção no campo: Complemento = " + complemento + " : está em branco!\n");
                    }

                    if (cidade.Contains("                    "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Atenção no campo: Cidade = " + cidade + " : está em branco!\n");
                    }
                    ...
                    try
                    {
                        ...
                        {
                            textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: CEP = " + cep + " : preencher com o zero a esquerda\n");
                        }
                    }
                    catch (Exception e)
                    {
                        textoValidacao +=  ("Linha: " + numLinha + " Erro no campo: CEP = " + cep + " : preencher com o CEP\n");
                    }

                    //if (cep.Contains("     "))
                    //{
                    //    textoValidacao += ("Linha: " + numLinha + " Atenção no campo: Complemento do CEP = " + cep + " : está em branco!\n");
                    //}

                    if (complementoCep.Contains("   "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Atenção no campo: Complemento do CEP = " + complementoCep + " : está em branco!\n");
                    }
                    ...
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Uso exclusivo FEBRABAN = " + usoFebraban + " : preencher com espaços\n");
                    }

                    if (!ocorrencias.Contains("          "))
                    {
                        textoValidacao += ("Linha: " + numLinha + " Erro no campo: Ocorrências = " + ocorrencias + " : preencher com espaços\n");
                    }
